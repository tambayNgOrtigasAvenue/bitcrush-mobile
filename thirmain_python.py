...
basic_prompts = [
    ...
    [
        ...
        {'syntax': 'print(5 + 3)', 'output': '8'},
        {'syntax': 'print(10 - 4)', 'output': '6'},
        {'syntax': 'print(2 * 3)', 'output': '6'},
        {'syntax': 'print(10 / 2)', 'output': '5.0'},
        {'syntax': 'x = 5\nprint(x)', 'output': '5'},
        {'syntax': 'print(len("Python"))', 'output': '6'},
        {'syntax': 'print("A" + "B")', 'output': 'AB'},
        {'syntax': 'y = 10\nprint(y)', 'output': '10'},
        {'syntax': 'print(15 % 4)', 'output': '3'},
        {'syntax': 'print(3 ** 2)', 'output': '9'},
        {'syntax': 'z = "Code"\nprint(z)', 'output': 'Code'},
        {'syntax': 'print("Easy".lower())', 'output': 'easy'},
    ],
]

basic_prompts[0].extend([
    {'syntax': 'print("Welcome to Python!")', 'output': 'Welcome to Python!'},
    {'syntax': 'print(7 + 3)', 'output': '10'},
    {'syntax': 'print(12 - 5)', 'output': '7'},
    {'syntax': 'print(4 * 2)', 'output': '8'},
    {'syntax': 'print(20 / 4)', 'output': '5.0'},
    {'syntax': 'a = 10\nprint(a)', 'output': '10'},
    {'syntax': 'print(len("Basic"))', 'output': '5'},
    {'syntax': 'print("A" + "B" + "C")', 'output': 'ABC'},
    {'syntax': 'b = 15\nprint(b)', 'output': '15'},
    {'syntax': 'print(18 % 7)', 'output': '4'},
    {'syntax': 'print(2 ** 3)', 'output': '8'},
    {'syntax': 'c = "Hello"\nprint(c)', 'output': 'Hello'},
    {'syntax': 'print("Python".lower())', 'output': 'python'},
    {'syntax': 'print("Basic".upper())', 'output': 'BASIC'},
    {'syntax': 'print(50 / 5)', 'output': '10.0'},
    {'syntax': 'print(9 + 6)', 'output': '15'},
    {'syntax': 'print("Code".find("o"))', 'output': '1'},
    {'syntax': 'print("Hello"[1:4])', 'output': 'ell'},
    {'syntax': 'print(25 - 10)', 'output': '15'},
    {'syntax': 'print(5 * 5)', 'output': '25'},
])
...
intermediate_prompts = [
    ...
    [
        ...
        {'syntax': 'print("Python".upper())', 'output': 'PYTHON'},
        {'syntax': 'print(len("Hello"))', 'output': '5'},
        {'syntax': 'print("Python".lower())', 'output': 'python'},
        {'syntax': 'print("Hello"[0:2])', 'output': 'He'},
        {'syntax': 'arr = [1, 2, 3]\nprint(arr[1])', 'output': '2'},
        {'syntax': 'print("Python".replace("y", "i"))', 'output': 'Pithon'},
        {'syntax': 'print(max(10, 20))', 'output': '20'},
        {'syntax': 'nums = [10, 20, 30]\nprint(len(nums))', 'output': '3'},
        {'syntax': 'print("Intermediate".index("e"))', 'output': '2'},
        {'syntax': 'print("Code" * 2)', 'output': 'CodeCode'},
        {'syntax': 'a = 5\nb = 10\nprint(a + b)', 'output': '15'},
        {'syntax': 'print("Python"[0:4])', 'output': 'Pyth'},
    ],
]

intermediate_prompts[0].extend([
    {'syntax': 'name = "Intermediate"\nprint(name)', 'output': 'Intermediate'},
    {'syntax': 'print("Python".upper())', 'output': 'PYTHON'},
    {'syntax': 'print(len("World"))', 'output': '5'},
    {'syntax': 'print("Intermediate".lower())', 'output': 'intermediate'},
    {'syntax': 'print("World"[0:3])', 'output': 'Wor'},
    {'syntax': 'arr = [5, 10, 15]\nprint(arr[2])', 'output': '15'},
    {'syntax': 'print("Python".replace("Py", "My"))', 'output': 'Mython'},
    {'syntax': 'print(max(30, 50))', 'output': '50'},
    {'syntax': 'nums = [5, 10, 15]\nprint(len(nums))', 'output': '3'},
    {'syntax': 'print("Intermediate".index("e"))', 'output': '2'},
    {'syntax': 'print("Code" * 3)', 'output': 'CodeCodeCode'},
    {'syntax': 'x = 20\ny = 30\nprint(x + y)', 'output': '50'},
    {'syntax': 'print("Python"[2:6])', 'output': 'thon'},
    {'syntax': 'print("Hello".replace("l", "p"))', 'output': 'Heppo'},
    {'syntax': 'print(min(8, 12))', 'output': '8'},
    {'syntax': 'print("Python".startswith("Py"))', 'output': 'True'},
    {'syntax': 'print("Hello".endswith("o"))', 'output': 'True'},
    {'syntax': 'print("Intermediate".count("e"))', 'output': '3'},
    {'syntax': 'print("Python".find("y"))', 'output': '1'},
])
...
advanced_prompts = [
    ...
    [
        ...
        {'syntax': 'for i in range(3):\n for j in range(2):\n        print(i + j)', 'output': '0\n1\n1\n2\n2\n3'},
        {'syntax': 'import math\nprint(math.pow(2, math.sqrt(4)))', 'output': '4.0'},
        {'syntax': 'print("Python".replace("y", "i"))', 'output': 'Pithon'},
        {'syntax': 'print("Python".index("y"))', 'output': '1'},
        {'syntax': 'print("Python".rindex("o"))', 'output': '4'},
        {'syntax': 'matrix = [[1, 2], [3, 4]] \nprint(matrix[1][0])', 'output': '3'},
        {'syntax': 'print("Python".startswith("Py"))', 'output': 'True'},
        {'syntax': 'obj = {"a": 1, "b": 2} \nprint(obj["a"])', 'output': '1'},
        {'syntax': 'nums = [1, 2, 3]\nnums.append(4)\nprint(nums)', 'output': '[1, 2, 3, 4]'},
        {'syntax': 'print([x * 2 for x in [1, 2, 3]])', 'output': '[2, 4, 6]'},
        {'syntax': 'str = "Advanced" \nprint("".join(reversed(str)))', 'output': 'decnavdA'},
        {'syntax': 'print(round(4.7))', 'output': '5'},
    ],
]

advanced_prompts[0].extend([
    {'syntax': 'for i in range(4):\n    print(i)', 'output': '0\n1\n2\n3'},
    {'syntax': 'for i in range(2):\n    for j in range(3):\n        print(i + j)', 'output': '0\n1\n2\n1\n2\n3'},
    {'syntax': 'import math\nprint(math.sqrt(16))', 'output': '4.0'},
    {'syntax': 'print("Advanced".replace("a", "o"))', 'output': 'ovonced'},
    {'syntax': 'print("Advanced".index("v"))', 'output': '2'},
    {'syntax': 'print("Advanced".rindex("d"))', 'output': '7'},
    {'syntax': 'matrix = [[2, 4], [6, 8]]\nprint(matrix[0][1])', 'output': '4'},
    {'syntax': 'print("Advanced".startswith("Adv"))', 'output': 'True'},
    {'syntax': 'obj = {"x": 10, "y": 20}\nprint(obj["y"])', 'output': '20'},
    {'syntax': 'nums = [2, 4, 6]\nnums.append(8)\nprint(nums)', 'output': '[2, 4, 6, 8]'},
    {'syntax': 'print([x * 2 for x in [1, 2, 3]])', 'output': '[2, 4, 6]'},
    {'syntax': 'str = "Advanced"\nprint("".join(reversed(str)))', 'output': 'decnavdA'},
    {'syntax': 'print(round(5.3))', 'output': '5'},
    {'syntax': 'print("Advanced"[3:7])', 'output': 'ance'},
    {'syntax': 'print("Advanced".replace("e", "i"))', 'output': 'Advanciid'},
    {'syntax': 'print("Advanced".count("a"))', 'output': '2'},
    {'syntax': 'print("Advanced".find("v"))', 'output': '2'},
    {'syntax': 'print("Advanced".upper())', 'output': 'ADVANCED'},
    {'syntax': 'print("Advanced".lower())', 'output': 'advanced'},
])
...
def reset_round():
    ...
    words = [prompt for sublist in round_words for prompt in sublist] if isinstance(round_words[0], list) else round_words

    # Check if words are available
    if not words or not isinstance(words[0], dict):
        print("Error: No valid words available after resetting round!")  # Debugging output
        return
...
def set_difficulty():
    ...
    words = [prompt for sublist in round_words for prompt in sublist] if isinstance(round_words[0], list) else round_words
    if not words or not isinstance(words[0], dict):
        print("Error: No valid words available after selecting difficulty!")  # Debugging output
