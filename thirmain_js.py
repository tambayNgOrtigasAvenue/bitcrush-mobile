...
basic_prompts = [
    # Easy prompts
    [
        {'syntax': 'console.log("Hello, World!");', 'output': 'Hello, World!'},
        {'syntax': 'console.log(5 + 3);', 'output': '8'},
        {'syntax': 'console.log(10 - 4);', 'output': '6'},
        {'syntax': 'console.log(2 * 3);', 'output': '6'},
        {'syntax': 'console.log(10 / 2);', 'output': '5'},
        {'syntax': 'let x = 5; console.log(x);', 'output': '5'},
        {'syntax': 'console.log("JavaScript".length);', 'output': '10'},
        {'syntax': 'console.log("A" + "B");', 'output': 'AB'},
        {'syntax': 'let y = 10; console.log(y);', 'output': '10'},
        {'syntax': 'console.log(15 % 4);', 'output': '3'},
        {'syntax': 'console.log(3 ** 2);', 'output': '9'},
        {'syntax': 'let z = "Code"; console.log(z);', 'output': 'Code'},
        {'syntax': 'console.log("Easy".toLowerCase());', 'output': 'easy'},
        {'syntax': 'console.log("Welcome to JavaScript!");', 'output': 'Welcome to JavaScript!'},
        {'syntax': 'console.log(7 + 3);', 'output': '10'},
        {'syntax': 'console.log(12 - 5);', 'output': '7'},
        {'syntax': 'console.log(4 * 2);', 'output': '8'},
        {'syntax': 'console.log(20 / 4);', 'output': '5'},
        {'syntax': 'let a = 10; console.log(a);', 'output': '10'},
        {'syntax': 'console.log("Basic".length);', 'output': '5'},
        {'syntax': 'console.log("A" + "B" + "C");', 'output': 'ABC'},
        {'syntax': 'let b = 15; console.log(b);', 'output': '15'},
        {'syntax': 'console.log(18 % 7);', 'output': '4'},
        {'syntax': 'console.log(2 ** 3);', 'output': '8'},
        {'syntax': 'let c = "Hello"; console.log(c);', 'output': 'Hello'},
        {'syntax': 'console.log("JavaScript".toLowerCase());', 'output': 'javascript'},
        {'syntax': 'console.log("Basic".toUpperCase());', 'output': 'BASIC'},
        {'syntax': 'console.log(50 / 5);', 'output': '10'},
        {'syntax': 'console.log(9 + 6);', 'output': '15'},
        {'syntax': 'console.log("Code".charAt(0));', 'output': 'C'},
        {'syntax': 'console.log("Hello".substring(1, 4));', 'output': 'ell'},
        {'syntax': 'console.log(25 - 10);', 'output': '15'},
        {'syntax': 'console.log(5 * 5);', 'output': '25'},
    ],
]
...
intermediate_prompts = [
    ...
    [
        {'syntax': 'let name = "JavaScript"; console.log(name);', 'output': 'JavaScript'},
        {'syntax': 'console.log("JavaScript".toUpperCase());', 'output': 'JAVASCRIPT'},
        {'syntax': 'console.log("Hello".length);', 'output': '5'},
        {'syntax': 'console.log("JavaScript".toLowerCase());', 'output': 'javascript'},
        {'syntax': 'console.log("Hello".substring(0, 2));', 'output': 'He'},
        {'syntax': 'let arr = [1, 2, 3]; console.log(arr[1]);', 'output': '2'},
        {'syntax': 'console.log("JavaScript".replace("a", "o"));', 'output': 'JovoScript'},
        {'syntax': 'console.log(Math.max(10, 20));', 'output': '20'},
        {'syntax': 'let nums = [10, 20, 30]; console.log(nums.length);', 'output': '3'},
        {'syntax': 'console.log("Intermediate".indexOf("e"));', 'output': '2'},
        {'syntax': 'console.log("Code".repeat(2));', 'output': 'CodeCode'},
        {'syntax': 'let a = 5; let b = 10; console.log(a + b);', 'output': '15'},
        {'syntax': 'console.log("JavaScript".slice(0, 4));', 'output': 'Java'},
        {'syntax': 'let name = "Intermediate"; console.log(name);', 'output': 'Intermediate'},
        {'syntax': 'console.log("JavaScript".toUpperCase());', 'output': 'JAVASCRIPT'},
        {'syntax': 'console.log("World".length);', 'output': '5'},
        {'syntax': 'console.log("Intermediate".toLowerCase());', 'output': 'intermediate'},
        {'syntax': 'console.log("World".substring(0, 3));', 'output': 'Wor'},
        {'syntax': 'let arr = [5, 10, 15]; console.log(arr[2]);', 'output': '15'},
        {'syntax': 'console.log("JavaScript".replace("Script", "Lang"));', 'output': 'JavaLang'},
        {'syntax': 'console.log(Math.max(30, 50));', 'output': '50'},
        {'syntax': 'let nums = [5, 10, 15]; console.log(nums.length);', 'output': '3'},
        {'syntax': 'console.log("Intermediate".indexOf("e"));', 'output': '2'},
        {'syntax': 'console.log("Code".repeat(3));', 'output': 'CodeCodeCode'},
        {'syntax': 'let x = 20; let y = 30; console.log(x + y);', 'output': '50'},
        {'syntax': 'console.log("JavaScript".slice(4, 10));', 'output': 'Script'},
        {'syntax': 'console.log("Hello".replace("l", "p"));', 'output': 'Heppo'},
        {'syntax': 'console.log(Math.min(8, 12));', 'output': '8'},
        {'syntax': 'console.log("JavaScript".includes("Script"));', 'output': 'true'},
        {'syntax': 'console.log("Hello".endsWith("o"));', 'output': 'true'},
        {'syntax': 'console.log("Intermediate".startsWith("Inter"));', 'output': 'true'},
        {'syntax': 'console.log("Intermediate".lastIndexOf("e"));', 'output': '10'},
    ],
]
...
advanced_prompts = [
    # Advanced prompts
    [
        {'syntax': 'for(let i = 0; i < 3; i++) { console.log(i); }', 'output': '0\n1\n2'},
        {'syntax': 'for(let i = 0; i < 3; i++) { for(let j = 0; j < 2; j++) { console.log(i + j); } }', 'output': '0\n1\n1\n2\n2\n3'},
        {'syntax': 'console.log(Math.pow(2, Math.sqrt(4)));', 'output': '4'},
        {'syntax': 'console.log("JavaScript".replace("a", "o"));', 'output': 'JovoScript'},
        {'syntax': 'console.log("JavaScript".indexOf("a"));', 'output': '1'},
        {'syntax': 'console.log("JavaScript".lastIndexOf("a"));', 'output': '3'},
        {'syntax': 'let matrix = [[1, 2], [3, 4]]; console.log(matrix[1][0]);', 'output': '3'},
        {'syntax': 'console.log("JavaScript".startsWith("Java"));', 'output': 'true'},
        {'syntax': 'let nums = [1, 2, 3]; nums.push(4); console.log(nums);', 'output': '1,2,3,4'},
        {'syntax': 'console.log([1, 2, 3].map(x => x * 2));', 'output': '2,4,6'},
        {'syntax': 'let str = "Advanced"; console.log(str.split("").reverse().join(""));', 'output': 'decnavdA'},
        {'syntax': 'console.log(Math.round(4.7));', 'output': '5'},
        {'syntax': 'for(let i = 0; i < 4; i++) { console.log(i); }', 'output': '0\n1\n2\n3'},
        {'syntax': 'for(let i = 0; i < 2; i++) { for(let j = 0; j < 3; j++) { console.log(i + j); } }', 'output': '0\n1\n2\n1\n2\n3'},
        {'syntax': 'console.log(Math.pow(3, Math.sqrt(9)));', 'output': '9'},
        {'syntax': 'console.log("Advanced".replace("a", "o"));', 'output': 'ovonced'},
        {'syntax': 'console.log("Advanced".indexOf("v"));', 'output': '2'},
        {'syntax': 'console.log("Advanced".lastIndexOf("d"));', 'output': '7'},
        {'syntax': 'let matrix = [[2, 4], [6, 8]]; console.log(matrix[0][1]);', 'output': '4'},
        {'syntax': 'console.log("Advanced".startsWith("Adv"));', 'output': 'true'},
        {'syntax': 'let nums = [2, 4, 6]; nums.push(8); console.log(nums);', 'output': '2,4,6,8'},
        {'syntax': 'console.log([3, 6, 9].map(x => x / 3));', 'output': '1,2,3'},
        {'syntax': 'let str = "Advanced"; console.log(str.split("").reverse().join(""));', 'output': 'decnavdA'},
        {'syntax': 'console.log(Math.round(5.3));', 'output': '5'},
        {'syntax': 'console.log("Advanced".substring(3, 7));', 'output': 'ance'},
        {'syntax': 'console.log("Advanced".replaceAll("e", "i"));', 'output': 'Advanciid'},
        {'syntax': 'console.log("Advanced".match(/a/g));', 'output': 'a,a'},
        {'syntax': 'console.log("Advanced".charAt(5));', 'output': 'c'},
        {'syntax': 'console.log("Advanced".toUpperCase());', 'output': 'ADVANCED'},
        {'syntax': 'console.log("Advanced".toLowerCase());', 'output': 'advanced'},
    ],
]
...
def reset_round():
    ...
    words = [prompt for sublist in round_words for prompt in sublist]  # Flatten nested lists into a single list
